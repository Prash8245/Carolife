...
export default function Content() {
  return (
    <div className='bg-gray-100'>
       <h1 className="title-font text-center sm:text-4xl text-3xl mb-4 font-medium text-gray-900"><u>Hospitals</u></h1>
      <section className="text-gray-600 body-font">
            <div className="px-5 py-24 mx-auto">
                ...
                
                {
                    data.map((elements)=>{
                        return(
                            <Link to="/hospital" state={elements} className="xl:w-1/4 md:w-1/2 p-4">
